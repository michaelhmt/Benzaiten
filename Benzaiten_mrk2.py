...
def create_model():
	...
	model.add(LSTM(50, input_shape=(X_modified.shape[1], X_modified.shape[2]), return_sequences=True)) # first number is how many set from the for loop above will be fed run through in one go,after that is creating the right shape of variables 
